...
const templates = [
  ...
  // ── Choice Wireless ─────────────────────────────────────────────────────────
  {
    ...
    data: {
      description: 'Choice Wireless eSIM provider (legacy UrlToken connector). Uses bearer token auth with URL-path token replacement.',
      connectorType: 'STANDARD',
    ...
    provider: {
      ...
      config: {
        ...
        _note: 'Choice uses UrlTokenConnector with {token} in URL path. Set apiBaseUrl and apiToken manually.',
      },
