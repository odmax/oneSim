...
const templates = [
  ...
  // ── Choice Wireless ─────────────────────────────────────────────────────────
  {
    ...
    data: {
      ...
      isSystemTemplate: true,
      configurationFields: [
        { key: 'username', label: 'Username', type: 'text', required: true, secret: false, group: 'credentials', placeholder: 'VirtuoLink username' },
        { key: 'password', label: 'Password', type: 'password', required: true, secret: true, group: 'credentials', placeholder: 'VirtuoLink password' },
        { key: 'authUrl', label: 'Auth URL', type: 'readonly', required: true, group: 'endpoints', default: 'https://psa.virtuolink.org/WebService/accounts/getaccounts' },
        { key: 'apiBaseUrl', label: 'API Base URL', type: 'readonly', required: true, group: 'endpoints', default: 'https://lpaasapi.psasoft.com:443' },
        { key: 'apiVersion', label: 'API Version', type: 'readonly', group: 'endpoints', default: 'v03_09' },
        { key: 'tokenPlacement', label: 'Token Placement', type: 'readonly', group: 'endpoints', default: 'URL_PATH' },
        { key: 'testEndpoint', label: 'Test Endpoint', type: 'readonly', group: 'testing', default: '/account/v03_09/bundle_templates/{token}' },
      ],
    },
    provider: {
      code: 'CHOICE',
